...
import type { ImageProps } from 'react-native-web/dist/exports/types'

import * as React from 'react'
import createElement from 'react-native-web/dist/exports/createElement'
import css from 'react-native-web/dist/exports/StyleSheet/css'
import { getAssetByID } from 'react-native-web/dist/exports/../modules/AssetRegistry'
import resolveShadowValue from 'react-native-web/dist/exports/StyleSheet/resolveShadowValue'
import ImageLoader from 'react-native-web/dist/exports/../modules/ImageLoader'
...
function createTintColorSVG(tintColor, id) {
  return tintColor && id != null ? (
    <svg style={{
      position: 'absolute', height: 0, visibility: 'hidden', width: 0,
    }}
    >
      <defs>
        <filter
...
function getFlatStyle(style, blurRadius, filterId) {
  ...
  const {
    filter, resizeMode, shadowOffset, tintColor,
  } = flatStyle
...
const ImageWithStatics = (Image as React.AbstractComponent<
ImageProps,
