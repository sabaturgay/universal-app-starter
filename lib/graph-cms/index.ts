...
export type GetPageQuery = { __typename?: 'Query', page?: { __typename?: 'Page', id: string, createdAt: any, updatedAt: any, title: string, slug: string, subtitle?: string | null | undefined, content: { __typename?: 'RichText', text: string } } | null | undefined };
...
export const useGetPageQuery = <
    ...
    useQuery<GetPageQuery, TError, TData>(
      ...
      fetcher<GetPageQuery, GetPageQueryVariables>(GetPageDocument, variables),
      options
    );

useGetPageQuery.getKey = (variables?: GetPageQueryVariables) => variables === undefined ? ['GetPage'] : ['GetPage', variables];
;
